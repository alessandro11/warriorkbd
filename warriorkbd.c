/*
 *  Copyright (c) 2016 Alessandro Elias
 *
 *  Warrior TC-200 USB Keyboard support
 */
...
#define DRIVER_AUTHOR "Alessandro Elias <ae11@c3sl.ufpr.br>"
#define DRIVER_DESC "Warrior tc-200 Keyboard Driver"
			 ...
			 const struct usb_device_id *id)
{
	...
	printk("<1>warriorkbd: detected %s\n", kbd->name);
